...
During preparation of this manuscript, the authors used OpenAI Codex, a generative-AI tool, to assist with research-question exploration, methodological planning, code drafting and debugging, analysis interpretation, and manuscript drafting. The authors independently reviewed and verified the study design, analyses, results, citations, and final text, and remain fully responsible for the originality, accuracy, integrity, and conclusions of this work. No generative AI was used to fabricate data, results, or figures.
